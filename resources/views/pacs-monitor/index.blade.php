    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex gap-1 mb-4">
                @foreach(['' => 'All', 'waiting' => 'Waiting', 'sent' => 'Sent', 'failed' => 'Failed'] as $val => $label)
                            ...
                            @forelse($items as $item)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        @endphp
                                        <span class="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-full {{ $colors[$item->status] ?? 'bg-gray-100 text-gray-700' }}">{{ ucfirst($item->status) }}</span>
                                    </td>
