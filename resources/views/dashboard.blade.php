        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
                <div class="bg-blue-50 rounded-lg border border-blue-200 p-4 text-center">
                    ...
                    <p class="text-xs text-blue-600 font-medium">Waiting MWL</p>
                </div>
                <div class="bg-yellow-50 rounded-lg border border-yellow-200 p-4 text-center">
                    ...
                    <p class="text-xs text-yellow-600 font-medium">In Progress</p>
                </div>
                ...
                <div class="bg-indigo-50 rounded-lg border border-indigo-200 p-4 text-center">
                    <p class="text-2xl font-bold text-indigo-700">{{ $stats['sent'] }}</p>
                    <p class="text-xs text-indigo-600 font-medium">Sent to PACS</p>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg border border-gray-200 p-4 text-center">
                    ...
                    <p class="text-xs text-gray-600 font-medium">DCM4CHEE</p>
                </div>
            </div>
