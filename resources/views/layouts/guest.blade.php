    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-gray-100 to-gray-200">
        <div class="mb-6">
            <a href="/" class="flex items-center gap-3">
                ...
                <span class="text-xl font-semibold text-gray-900">{{ config('app.name', 'DCM4CHEE Console') }}</span>
            </a>
        </div>
        <div class="w-full sm:max-w-md bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            {{ $slot }}
        </div>
    </div>
</body>
